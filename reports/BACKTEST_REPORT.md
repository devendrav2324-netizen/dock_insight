# CharterAI — Historical Walk-Forward Backtesting Report (Phase 11)
...
This report documents the rigorous historical walk-forward backtest of CharterAI's end-to-end maritime chartering intelligence architecture against 5 established commercial baselines across the 2022–2024 period.

### Key Findings

- **Cost Efficiency vs Spot Baseline:** CharterAI achieved a **3.17% total delivered cost reduction** (saving **$2,204,734.55**) compared to immediate spot chartering.
...
| :--- | :---: | :---: | :---: | :---: | :---: |
| **CharterAI Ensemble** | $0.254 | $0.361 | $0.439 | $0.585 | 3.16% |
...
| Test Year | CharterAI MAE (days) | Historical Baseline MAE (days) | Improvement |
| :---: | :---: | :---: | :---: |
...
| :--- | :---: | :---: | :---: | :---: | :---: |
| **CharterAI Decision Engine** | $67,376,438 | $19.36/t | $261,000 | 0.00 d | 100.0% |
...
| :--- | :---: | :---: | :---: | :---: | :---: |
| **CharterAI Decision Engine** | $2,592,828 | $3,230,689 | 100.0% | $2,736,861 | $3.07/t |
